...
parse.add_argument('-c', '--conversion', action='store_false',
                   help='default DOS to UINX else UINX to DOS.')

parse.add_argument('-f', '--inencoding', metavar='',
                   default='gb18030', help='input encode default: %(default)s')

parse.add_argument('-t', '--outencoding', metavar='',
                   default='utf-8', help='output encode default: %(default)s')

parse.add_argument('-o', '--outfile', metavar='',
                   required=True, help='output filename')

parse.add_argument('files', metavar='files',
                   help='filename')  # nargs=REMAINDER)
