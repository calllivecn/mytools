...
parse = argparse.ArgumentParser(
    description='Gzip compress and decompress', usage='Usage: [Option]... [File]...', epilog='end')

parse.add_argument('-c', '--stdout', action='store_true',
                   help='write on standard output, keep original files unchanged')

parse.add_argument('-d', '--decompress',
                   action='store_true', help='decompress')

parse.add_argument('-k', '--keep', action='store_false',
