...
parse = argparse.ArgumentParser(
    usage=" Using : %(prog)s <options> [file|directory]...")
...
parse.add_argument("-C", dest="chdir", default=".",
                   help="change work directory")

parse.add_argument("-f", dest="itar", required=True,
                   help="itar filename suffix is *.itar")

parse.add_argument("-v", dest="verbose", action="count",
                   help="print verbose info")

parse.add_argument("files", nargs="*", type=chk_fullname,
                   help="file or dirs ...")
