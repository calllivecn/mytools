...
group1.add_argument('-c', '--create', action='store_true',
                    help='create a new archive')

group1.add_argument('-x', '--extract', action='store_true',
                    help='extract files from an archive')

group1.add_argument('-t', '--list', action='store_true',
                    help='list the contents of an archive')

parse.add_argument('-f', '--file', action='store', required=True,
...
parse.add_argument('-C', '--directory', action='store',
                   default=os.getcwd(), help='change to directory DIR')

group2 = parse.add_mutually_exclusive_group()

group2.add_argument('-z', '--gzip', action='store_true',
                    help='filter the archive through gzip')

group2.add_argument('-j', '--bzip2', action='store_true',
                    help='filter the archive through bzip2')

group2.add_argument('-J', '--xz', dest='xz', action='store_true',
                    help='filter the archive through xz')
